...
class vosk_sr():
    def __init__(self):
        ...
        rospack.list()
        package_path = rospack.get_path('vosk_ros')
        ...
        # ROS node initialization /espeak_node/speak_line
    ...
    def get_session_status(self,msg):
        self.tts_status = msg.data

    def session_listener(self):
        rospy.Subscriber('/stt_session_key', Bool, self.get_session_status)
